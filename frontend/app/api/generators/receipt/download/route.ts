/**
 * API Route: Download Receipt PDF
 * POST /api/generators/receipt/download
 *
 * Generates and returns PDF for a receipt template
...
const TOOL_NAME = "receipt-generator";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const resolvedTemplateId =
      template_id && RECEIPT_TEMPLATE_IDS.includes(template_id)
        ? template_id
        : DEFAULT_TEMPLATE_ID;
