/**
 * API Route: Download Packing Slip PDF
 * POST /api/generators/packing-slip/download
 *
 * Generates and returns PDF for a packing slip template
...
const TOOL_NAME = "packing-slip-generator";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const resolvedTemplateId =
      template_id && PACKING_SLIP_TEMPLATE_IDS.includes(template_id)
        ? template_id
        : DEFAULT_TEMPLATE_ID;
