/**
 * API Route: Download Shipping Label PDF
 * POST /api/generators/shipping-label/download
 *
 * Generates and returns PDF for a shipping label template
...
const TOOL_NAME = "shipping-label-generator";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const resolvedTemplateId =
      template_id && SHIPPING_LABEL_TEMPLATE_IDS.includes(template_id)
        ? template_id
        : DEFAULT_TEMPLATE_ID;
